...
### O projeto consiste em uma aplicação no estilo pomodoro.
<br>

### Suas funcionalidades consistem em:
<br>

 - Iniciar a contagem de uma nova tarefa
 - Interroper a contagem da tarefa ativa
 - Lista as tarefas já realizadas com seus status
